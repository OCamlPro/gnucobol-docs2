...
\item \textbf{New Micro Focus directives}: ADDRSV, ADDSYN, MAKESYN, OVERRIDE and REMOVE (\fr{210}); CALLFH and COMP1.
\end{itemize}
...
\item \textbf{SET statement}: fixed \bug{543}.
