...
\item \textbf{New compiler configuration options}: reference-bounds-check and report-column-plus.
...
\item \textbf{New directives}: ADDRSV, ADDSYN, MAKESYN, OVERRIDE and REMOVE (\fr{210}); CALLFH and COMP1.
\item \textbf{SET directive}: added XFD phrase.
\end{itemize}
...
\item \textbf{X"91" function}: corrected number of arguments from 2 to 3 (\bug{527}).
