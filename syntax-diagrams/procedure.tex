...
\begin{syntax}[\miscextcolour]
  ...
  \gnucobol{
    \begin{0+}
      ...
      \key{NOT} ON \key{INVALID} \imperativestatement
    \end{0+}
  }
...
\format{for GO TO}
\begin{syntax}[\gnucobolcolour]
  \key{ENTRY} \key{FOR} \key{GO} \key{TO} \literal
\end{syntax}
...
\begin{syntax}[\miscextcolour]
  ...
  \end{0-1}
  \begin{0-1}
    \defdmetaelement{exhibit-pos-spec}
  \end{0-1}
  \begin{0-1}
    \key{ERASE}
  \end{0-1}
...
where \defnmetaelement{exhibit-pos-spec} is

\begin{syntax}[\miscextcolour]
  \begin{1=}
    (\ \defdmetaelement{exhibit-pos-spec-num}\ ,\ \defdmetaelement{exhibit-pos-spec-num}\ ) \\
    (\ ,\ \defdmetaelement{exhibit-pos-spec-num}\ ) \\
    (\ \defdmetaelement{exhibit-pos-spec-num}\ ,\ )
  \end{1=}
\end{syntax}

where \defnmetaelement{exhibit-pos-spec-num} is
...
\begin{syntax}
  ...
  \begin{1=}
    \procedurename \ldots \\
    \gnucobol{\key{ENTRY} \metaelement{entry-name} \ldots}
  \end{1=}
  \begin{0-1}
